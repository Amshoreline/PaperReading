...
> This page quotes from https://github.com/zhjohnchan/awesome-image-captioning
...
- [Hybrid Retrieval-Generation Reinforced Agent for Medical Image Report Generation](https://arxiv.org/abs/1805.08298) `NIPS 2018`.
- [On the Automatic Generation of Medical Imaging Reports](https://arxiv.org/abs/1711.08195) `ACL 2018`.
- [ChestX-ray8: Hospital-scale Chest X-ray Database and Benchmarks on Weakly-Supervised Classification and Localization of Common Thorax Diseases](https://arxiv.org/abs/1705.02315) `CVPR 2017`.
- [TieNet: Text-Image Embedding Network for Common Thorax Disease Classification and Reporting in Chest X-rays](https://arxiv.org/abs/1801.04334v1) `CVPR 2018`.
- [Knowledge-Driven Encode, Retrieve, Paraphrase for Medical Image Report Generation](http://arxiv.org/abs/1903.10122) `AAAI 2019`.
